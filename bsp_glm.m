...
switch(what)
   ...
   case 'test_GLM_script'
    ...
    case 'test_GLM_Physio_full_model'
        ...
        D=bsp_glm('test_GLM','sn',sn,'roi',roi,'inK',inK,'inX',model,'reg',method,'runs',[1:16]);
        save(fullfile(baseDir,'results','test_GLM_physio_full_model.mat'),'-struct','D');
        varargout={D};
    ...
    case 'plot_GLM_Physio_full_model'
        ...
        D=load('test_GLM_physio_full_model.mat');
    ...
    case 'test_GLM_Physio_full_model_task'
        ...
        D=bsp_glm('test_GLM','sn',sn,'roi',roi,'inK',inK,'inX',model,'reg',method,'runs',[1:16]);
        save(fullfile(baseDir,'results','test_GLM_physio_full_model_task.mat'),'-struct','D');
        varargout={D};
    ...
    case 'plot_GLM_Physio_full_model_task'
        ...
        D=load('test_GLM_physio_full_model_task.mat');
