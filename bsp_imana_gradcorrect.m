...
imagingDir      ='/imaging_data_gradcorrect';
imagingDirRaw   ='/imaging_data_raw_gradcorrect';
anatomicalDir   ='/anatomicals_gradcorrect';
suitDir         ='/suit_gradcorrect';
regDir          ='/RegionOfInterest_gradcorrect';
%========================================================================================================================
% PRE-PROCESSING 
subj_name = {'p04-gradcorrect'};
